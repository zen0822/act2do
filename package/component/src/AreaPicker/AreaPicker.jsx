...
class AreaPicker extends Component {
    ...
    _changeData(provinceId, cityId) {
        ...
        provinceListKeys.forEach((itemProvinceId, provinceIndex) => {
            ...
            let cityList = provinceListValues[provinceIndex].citys
