...
class Slideshow extends Component {
  ...
  _handlerTouchEnd() {
    ...
    const xDistance = this.touchEnd.x - this.touchStart.x
  ...
  pre(index) {
    ...
    const currentItemIndex = this.state.currentIndex
    const preItemIndex = index === undefined
    ...
    this._isMounted && this.setState({
      ...
      // HACK: reflow
      const height = this.refs.me.offsetHeight
  ...
  next(index) {
    ...
    const currentItemIndex = this.state.currentIndex
    const nextItemIndex = index === undefined
